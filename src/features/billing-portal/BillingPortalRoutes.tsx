...
import BillingContractViewerPage from '@/features/billing-portal/BillingContractViewerPage';
...
const BillingPortalRoutes = () => (
  <>
    ...
    <Route
      path='/billing/payment-schedules'
      element={<BillingContractsListPage />}
    />
    <Route
      path='/billing/contracts/:contractId/view'
      element={<BillingContractViewerPage />}
    />
    <Route
