...
import { DeleteTemplateDialog } from '@/features/contracts/components/dialog/DeleteTemplateDialog';
import { EditTemplateDialog } from '@/features/contracts/components/dialog/EditTemplateDialog';
