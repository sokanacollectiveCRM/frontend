...
export default function Profile() {
  ...
  const [notes, setNotes] = useState<Note[]>([
    {
      id: 1,
      text: 'Client requested lactation support resources and referrals',
      date: 'Apr 22, 2025',
      category: 'support',
    },
    {
      id: 2,
      text: "Discussed different baby formula options based on baby's sensitivity",
      date: 'Apr 18, 2025',
      category: 'nutrition',
    },
  ]);
                ...
                {[
                  {
                    ...
                    description:
                      'Completed first trimester with healthy progress',
                    type: 'milestone',
      ...
      <Card className='w-[400px] p-6 rounded-2xl shadow-sm'>
        <div className='flex flex-col gap-2 items-center'>
          ...
          <p className='text-sm text-gray-500'>
            Expecting mother • {pregnancyData[0].currentWeek} weeks
          </p>
          ...
          <div className='ml-5 mt-6 w-full'>
            ...
            <div className='grid grid-cols-[max-content_1fr] gap-y-5 gap-x-10 text-[15px] w-full'>
              ...
              <p className='text-left break-words text-gray-800'>
                {client.email}
              </p>
