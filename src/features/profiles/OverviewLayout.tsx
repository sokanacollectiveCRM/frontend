          ...
          <div className='space-y-4'>
            <div className='flex items-center justify-between p-3 bg-muted/50 rounded-lg'>
              ...
              <div className='text-right'>
                <p className='text-sm font-medium'>
                  Week {pregnancyData[0].currentWeek}
                </p>
            ...
            <div className='flex items-center p-3 bg-muted/50 rounded-lg'>
              ...
              <div>
                ...
                <p className='text-sm text-muted-foreground'>
                  {pregnancyData[0].nextAppointment}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className='space-y-3'>
            {birthPreferences.map((pref, index) => (
              <div key={index} className='flex items-start'>
                <div
                  className={`min-w-2 h-2 rounded-full mt-2 mr-3 ${
                    pref.type === 'primary'
                      ? 'bg-primary'
                      : pref.type === 'environment'
                        ? 'bg-green-500'
                        : pref.type === 'medical'
                          ? 'bg-destructive'
                          : 'bg-purple-500'
      ...
      <Card className='p-6'>
        ...
        <div className='space-y-4'>
          {supportTeam.map((member, index) => (
            <div
              key={index}
              className='flex items-center justify-between p-3 border border-input rounded-lg hover:bg-muted/50 transition-colors'
            >
              <div>
