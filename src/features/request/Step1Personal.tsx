...
export function Step1Personal({ form, control, handleBack, handleNextStep, step, totalSteps }: any) {
  ...
  const handleFocus = (field: FocusField) => setFocus(f => ({ ...f, [field]: true }));
  const handleBlur = (field: FocusField) => setFocus(f => ({ ...f, [field]: false }));
  ...
  const isStepValid = stepFields[step].every(
    (field) => !errors[field]
  );
    ...
    <div>
      ...
      <div className={styles['form-grid']}>
        ...
        <div className={styles['form-field']}>
          ...
          <label
            ...
            className={
              ...
              ((focus.firstname || values.firstname) ? ' ' + styles['form-label--active'] : '')
            }
          >
            First Name
          </label>
        ...
        <div className={styles['form-field']}>
          ...
          <label
            ...
            className={
              styles['form-floating-label'] +
              ((focus.lastname || values.lastname) ? ' ' + styles['form-label--active'] : '')
            }
          >
            Last Name
          </label>
        ...
        <div className={styles['form-field']}>
          ...
          <label
            ...
            className={
              styles['form-floating-label'] +
              ((focus.phone_number || values.phone_number) ? ' ' + styles['form-label--active'] : '')
            }
          >
            Mobile phone
          </label>
        ...
        <div className={styles['form-field']} style={{ position: 'relative' }}>
          <select
            ...
            defaultValue=""
            onFocus={() => { handleFocus('preferred_contact_method'); setPcmOpen(true); }}
            onBlur={() => { handleBlur('preferred_contact_method'); setPcmOpen(false); }}
          >
          ...
          <label
            ...
            className={
              styles['form-floating-label'] +
              ((focus.preferred_contact_method || values.preferred_contact_method) ? ' ' + styles['form-label--active'] : '')
            }
            style={{ left: 0, color: pcmOpen ? '#00bcd4' : undefined, right: 0, maxWidth: 'calc(100% - 36px)' }}
          >
          ...
          {errors.preferred_contact_method && <div className={styles['form-error']}>{errors.preferred_contact_method.message as string}</div>}
        </div>
        <div className={styles['form-field']} style={{ position: 'relative' }}>
          <select
            className={styles['form-select']}
        ...
        <div className={styles['form-field']}>
          ...
          <label
            ...
            className={
              styles['form-floating-label'] +
              ((focus.preferred_name || values.preferred_name) ? ' ' + styles['form-label--active'] : '')
            }
          >
            Preferred name
          </label>
      ...
      <div className={styles['step-buttons-row']}>
        ...
        <Button type="submit" onClick={() => {
          ...
          handleNextStep();
        }} disabled={!isStepValid || form.formState.isSubmitting}>{step === totalSteps - 1 ? 'Submit' : 'Next'}</Button>
      </div>
    </div>
  );
} 