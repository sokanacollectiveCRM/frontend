export declare const callTypes: Map<"Active" | "In Progress" | "Completed", string>;
export declare const userTypes: readonly [{
    readonly label: "Superadmin";
