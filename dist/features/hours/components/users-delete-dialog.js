...
export function UsersDeleteDialog(_a) {
    ...
    var handleDelete = function () {
        if (value.trim() !== currentRow.firstName)
            return;
        onOpenChange(false);
        toast({
    ...
    return (_jsx(ConfirmDialog, { open: open, onOpenChange: onOpenChange, handleConfirm: handleDelete, disabled: value.trim() !== currentRow.firstName, title: _jsxs("span", { className: 'text-destructive', children: [_jsx(TriangleAlert, { className: 'mr-1 inline-block stroke-destructive', size: 18 }), ' ', "Delete User"] }), desc: _jsxs("div", { className: 'space-y-4', children: [_jsxs("p", { className: 'mb-2', children: ["Are you sure you want to delete", ' ', _jsx("span", { className: 'font-bold', children: currentRow.firstName }), "?", _jsx("br", {}), "This action will permanently remove the user with the role of", ' ', "from the system. This cannot be undone."] }), _jsxs(Label, { className: 'my-2', children: ["Username:", _jsx(Input, { value: value, onChange: function (e) { return setValue(e.target.value); }, placeholder: 'Enter username to confirm deletion.' })] }), _jsxs(Alert, { variant: 'destructive', children: [_jsx(AlertTitle, { children: "Warning!" }), _jsx(AlertDescription, { children: "Please be carefull, this operation can not be rolled back." })] })] }), confirmText: 'Delete', destructive: true }));
}
